...
const int potPin3 = 19;
const int potPin4 = 20;

const int greenLEDs[4] = {12, 9, 6, 3}; // Green LEDs on even pins
const int yellowLEDs[4] = {10, 8, 5, 1}; // Yellow LEDs on odd pins

// Define the letter range. Can be replaced with any 10 letters.
String letters = "adehmnorst"; 
String correctWord = "note"; 
...
void setup() {
  ...
  bool found = isStringInArray(correctWord, myArray2, 379);
...
void loop() {
  ...
  String combinedLetters = String(letter1) + String(letter2) + String(letter3) + String(letter4);
